...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='../Dataset/data.yaml', help='data.yaml path')  # 数据
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=120)
    parser.add_argument('--batch-size', type=int, default=120, help='total batch size for all GPUs')
    ...
    logger.info(opt)
    with open(opt.hyp, encoding='latin-1') as f:
